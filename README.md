...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0gvgucw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0gvgucw.containers.anotherwebservice.com/
...
```
git clone git@github.com:mriza/container-0gvgucw.git
cd container-0gvgucw
```
...
```
docker attach container-0gvgucw
```
